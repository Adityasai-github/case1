...
class FarmerLogin extends Component {
    ...
    changeLogInName(e){
      ...
      changeLogPass(e){
        this.setState({farmerpassword: e.target.value});
    }

    onLogIn(){
        let logindetail = {  dealername:this.state.farmername,
            dealerpassword:this.state.farmerpassword};

            axios.post("http://localhost:8083/trader/auth",logindetail)
    ...
    navigates(){
      ...
      this.props.navigate("/dealer-dash");
